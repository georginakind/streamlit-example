...
# testing_dict = {"please fucking work" : "yew"}
# st.write(testing_dict)

movies_dict_new = {
    "Who played the iconic character of Neo in The Matrix?": "Keanu Reeves",
    "In which film did Humphrey Bogart say the famous line, Here's looking at you, kid?": "Casablanca",
    "Which movie features a great white shark terrorizing the small town of Amity Island?": "Jaws",
    "What animated film tells the story of a young lion named Simba?": "The Lion King",
    "Who directed the science fiction classic 2001: A Space Odyssey?": "Stanley Kubrick",
    "In The Lord of the Rings trilogy, what is the name of the fictional world where the story takes place?": "Middle-earth",
    "Which actress won an Academy Award for her role as Margaret Thatcher in The Iron Lady?": "Meryl Streep",
    "What 1994 film brought Jim Carrey to stardom with his role as a man who can't lie for 24 hours?": "The Mask",
    "Who played the role of Jack Dawson in the film Titanic?": "Leonardo DiCaprio",
    "What is the highest-grossing animated film of all time, as of my last knowledge update in September 2021?": "Frozen II",
    "In the Harry Potter series, what is the name of Hagrid's pet dragon?": "Norbert",
    "Which film won the Academy Award for Best Picture in 2020?": "Parasite",
    "Who directed the sci-fi thriller Inception starring Leonardo DiCaprio?": "Christopher Nolan",
    "In Star Wars, what is the real name of the character known as Darth Vader?": "Anakin Skywalker",
    "Who played the iconic character of Captain Jack Sparrow in the Pirates of the Caribbean series?": "Johnny Depp",
    "What classic 1980s film features a time-traveling DeLorean car?": "Back to the Future",
    "Which actress won an Academy Award for her role in Black Swan?": "Natalie Portman",
    "What Quentin Tarantino film follows a pair of hitmen, Jules and Vincent, through a series of interconnected stories?": "Pulp Fiction",
    "Who wrote and directed the 1994 film Pulp Fiction?": "Quentin Tarantino",
    "In the Toy Story series, what is the name of Woody's trusty steed?": "Bullseye",
}
# st.write(movies_dict_new)
taylor_dict_new = {
    "What year was Taylor Swift born?": 1989,
    "What is Taylor Swift's middle name?": "Alison",
    "Taylor Swift made her debut with which self-titled album?": '"Taylor Swift"',
    'Which album features the hit song "Love Story"?': '"Fearless"',
    "What song won Taylor Swift her first Grammy Award?": '"White Horse"',
    "Taylor Swift's transition to pop music was marked by which album?": '"1989"',
    "In which music video did Taylor Swift dress up as various personas, including a male character?": '"You Belong with Me"',
    "What is the name of Taylor Swift's 2020 album that features a more indie-folk sound?": '"folklore"',
    'Which song from "folklore" won the Grammy Award for Song of the Year in 2021?': '"cardigan"',
    "Taylor Swift released a surprise album in December 2020; what is its name?": '"evermore"',
    "Which streaming platform did Taylor Swift initially have a feud with over her music catalog?": "Spotify",
    "Taylor Swift's documentary film, released on Netflix in 2020, is named after which album?": '"Miss Americana"',
    'What is the title of Taylor Swift\'s re-recorded version of her album "Fearless"?': '"Fearless (Taylor\'s Version)"',
    'Which song from her re-recorded "Fearless" album became her first song to top the Billboard Hot 100?': '"Love Story (Taylor\'s Version)"',
    'Taylor Swift\'s song "Shake It Off" is from which album?': '"1989"',
    "What is the name of Taylor Swift's loyal fanbase?": "Swifties",
    'Taylor Swift\'s 2020 album "folklore" was created in collaboration with which musician and producer?': "Aaron Dessner",
    'In which year did Taylor Swift win the Grammy Award for Album of the Year for "Fearless"?': 2010,
    "Which song by Taylor Swift became an anthem for individuality and self-acceptance?": '"ME!"',
}
sports_dict_new = {
    "Which country is credited with inventing the sport of soccer (football)?": "England",
    "In basketball, how many points is a free throw worth?": "1 point",
    "Who holds the record for the most home runs in Major League Baseball (MLB) history?": "Barry Bonds",
    "What is the highest possible score in a game of ten-pin bowling?": 300,
    'In which Olympic sport would you perform a "vault"?': "Gymnastics",
    "Which city hosted the 2016 Summer Olympics?": "Rio de Janeiro, Brazil",
    "How many players are there on a standard soccer (football) team, excluding substitutes?": 11,
    "What is the diameter of a standard basketball hoop in inches?": "18 inches",
    "In tennis, what is it called when both players are tied at 40 points?": "Deuce",
    "What is the maximum number of clubs a golfer can have in their bag according to the rules of golf?": 14,
    "Which country is famous for its dominance in the sport of cricket?": "India",
    "How many players are on the field for each team in a game of American football?": "11 players",
    "In which year did the first modern Olympic Games take place?": 1896,
    'Which boxer is often referred to as "The Greatest" and "The Champ"?': "Muhammad Ali",
    "What is the official ball used in a game of table tennis (ping pong)?": "A white or orange ball",
    "In baseball, how many strikes result in a strikeout for the batter?": "3 strikes",
    "Which country won the FIFA World Cup in 2018?": "France",
    "What is the distance of a marathon race in kilometers?": "42.195 kilometers",
    "Who is the all-time leading scorer in the NBA (National Basketball Association)?": "Kareem Abdul-Jabbar",
    "What is the term for a perfect game in bowling (12 consecutive strikes)?": "300 game",
}
general_dict_new = {
    ...
    "Which gas do plants absorb from the atmosphere during photosynthesis?": "Carbon dioxide (CO2)",
    "In which year did the Titanic sink?": 1912,
    "What is the largest organ in the human body?": "Skin",
    "Who painted the Mona Lisa?": "Leonardo da Vinci",
    "Which gas do humans breathe out during respiration?": "Carbon dioxide (CO2)",
    ...
    "What is the freezing point of water in degrees Celsius?": "0 degrees Celsius (32 degrees Fahrenheit)",
    "Who is the current President of the United States (as of my last knowledge update in September 2021)?": "Joe Biden",
}
...
meow_list = [
    ...
    "What's Luv? (feat. Ja-Rule & Ashanti) by Fat Joe, Ja Rule, Ashanti",
    ...
    "Steal My Sunshine - Single Version by LEN",
    "Take on Me by a-ha",
    "Live Your Life - feat. Rihanna by T.I., Rihanna",
    ...
    "This Is How We Do It by Montell Jordan, Wino",
    ...
    "American Boy (feat. Kanye West) by Estelle, Kanye West",
    "Finally by CeCe Peniston",
    "Reach by S Club",
    "Love On Top by BeyoncÌ©",
    ...
    "Crazy In Love (feat. Jay-Z) by BeyoncÌ©, JAY-Z",
    "Bootylicious by Destiny's Child",
    "Deja Vu (feat. Jay-Z) by BeyoncÌ©, JAY-Z",
    "Everybody (Backstreet's Back) - Radio Edit by Backstreet Boys",
    "I Wanna Dance with Somebody (Who Loves Me) by Whitney Houston",
    "Uptown Girl by Billy Joel",
    "Wake Me Up Before You Go-Go by Wham!",
    "Celebrate Good Times (Come On) by Funktown America",
    "Hey Mickey You're so Fine by The Original Chin Chins",
    "Mambo No. 5 (a Little Bit of...) by Lou Bega",
    "Wannabe by Spice Girls",
    "Bring It All Back by S Club",
    "Get the Party Started by P!nk",
    "The Way You Make Me Feel - Single Version by Michael Jackson",
    "Play That Funky Music by Wild Cherry",
    "Rock Your Body by Justin Timberlake",
    "Love Shack by The B-52's",
    "Tubthumping - Radio Edit by Chumbawamba",
    "Keep On Movin' by Five, Steve Mac",
    ...
    "Millionaire by Kelis, AndrÌ© 3000",
    "Signs by Snoop Dogg, Charlie Wilson, Justin Timberlake",
    "Day 'N' Nite - Crookers Remix by Kid Cudi, Crookers",
    "California Gurls by Katy Perry, Snoop Dogg",
    "Fake Magic by Peking Duk, AlunaGeorge, Aluna",
    "All Night (feat. Knox Fortune) by Chance the Rapper, Knox Fortune",
    "Sexual by NEIKED, Dyo",
    "Shake It by Metro Station",
    "Whatever You Like by T.I.",
    "Just the Way You Are by Milky",
    "You Sexy Thing - Radio Edit by T-Shirt",
    "Year 3000 by Busted",
    "Shake It Off by Taylor Swift",
    "The Horses by Daryl Braithwaite",
    "Sk8er Boi by Avril Lavigne",
    "Strawberry Kisses 2017 by Nikki Webster, Sam Mac",
    "Slice of Heaven by Dave Dobbyn",
    "September by Earth\\, Wind & Fire",
    "Low (feat. T-Pain) by Flo Rida, T-Pain",
    "April Sun in Cuba by Dragon",
    "That Don't Impress Me Much by Shania Twain",
    'You\'re The One That I Want - From "Grease" Original Motion Picture Soundtrack by John Travolta, Olivia Newton-John',
    "Greased Lightnin' - From ‰ÛÏGrease‰Û\x9d Soundtrack by John Travolta, Jeff Conaway",
    "Breaking Free by Troy, Gabriella, Disney",
    ...
    "Drive by Shannon Noll",
    "SeÌ±orita by Justin Timberlake",
    ...
    "Everywhere - 2017 Remaster by Fleetwood Mac",
    "Dance Wiv Me by Dizzee Rascal, Calvin Harris, Chrom3",
    "I'm Coming Out by Diana Ross",
    "Holiday by Dizzee Rascal, Laidback Luke",
    "Freaky Friday (feat. Chris Brown) by Lil Dicky, Chris Brown",
    "September by Earth\\, Wind & Fire",
    "Ms. Jackson by Outkast",
    "Remind Me to Forget by Kygo, Miguel",
    "Wall To Wall by Chris Brown",
    'Gotta Go My Own Way - From "High School Musical 2" by Troy, Gabriella Montez',
    "All My Friends by Snakehips, Tinashe, Chance the Rapper",
    "Livin' It Up by Ja Rule, Case",
    "Just Wanna Be With You by High School Musical Cast, Zac Efron, Lucas Grabeel, Olesya Rulin, Vanessa Hudgens",
    "Waterfalls by TLC",
    "Don't You (Forget About Me) - Remastered by Simple Minds",
    "Hey Ya! - Radio Mix / Club Mix by Outkast",
    "Ghetto Supastar (That is What You Are) (feat. Ol' Dirty Bastard & MÌ_a) by Pras, Ol' Dirty Bastard, MÌ_a",
    ...
    "Milkshake by Kelis",
    "Pony by Ginuwine",
    "Jenny from the Block (feat. Jadakiss & Styles P.) - Track Masters Remix by Jennifer Lopez, Jadakiss, Styles P",
    "Be Faithful by Fatman Scoop, Crooklyn Clan",
    "Roses by Outkast",
    ...
    "Thrift Shop (feat. Wanz) by Macklemore & Ryan Lewis, Macklemore, Ryan Lewis, Wanz",
    ...
    "You Can't Hurry Love - 2016 Remaster by Phil Collins",
    "I Want You Back by The Jackson 5",
    "Gasolina by Daddy Yankee",
    "Get Busy by Sean Paul",
    "Lady (Hear Me Tonight) by Modjo",
    "This Girl - Kungs Vs. Cookin' On 3 Burners by Kungs, Cookin' On 3 Burners",
    "Show Me Love (feat. Robin S.) by Steve Angello, Laidback Luke, Robin S",
    "Formation by BeyoncÌ©",
    "Mi Gente (feat. BeyoncÌ©) by J Balvin, Willy William, BeyoncÌ©",
    "Valerie (feat. Amy Winehouse) - Version Revisited by Mark Ronson, Amy Winehouse",
    "Shooting Stars by Bag Raiders",
    "Swalla (feat. Nicki Minaj & Ty Dolla $ign) by Jason Derulo, Nicki Minaj, Ty Dolla $ign",
    "Can't Hold Us (feat. Ray Dalton) by Macklemore & Ryan Lewis, Macklemore, Ryan Lewis, Ray Dalton",
    "Pursuit Of Happiness - Extended Steve Aoki Remix (Explicit) by Kid Cudi, MGMT, Ratatat",
    "Pony by Ginuwine",
    "Party Up by DMX",
    "Jump Around by House Of Pain",
    "Can't Stop by Red Hot Chili Peppers",
    'Lady Marmalade - From "Moulin Rouge" Soundtrack by Christina Aguilera, Lil\' Kim, MÌ_a, P!nk',
    "It Wasn't Me by Shaggy, Rik Rok",
    ...
    "Touch The Sky by Kanye West, Lupe Fiasco",
    "Tribute by Tenacious D",
    "Rock DJ - 2004 Mix by Robbie Williams",
    "Hot In Herre by Nelly",
    "Memories (feat. Kid Cudi) by David Guetta, Kid Cudi",
    "In My Mind by Dynoro, Gigi D'Agostino",
    "Let's Groove by Earth\\, Wind & Fire",
    "I See You Baby - Fatboy Slim Radio Edit by Groove Armada, Gram'ma Funk",
    "House Work by Jax Jones, Mike Dunn, MNEK",
    "Move Your Feet by Junior Senior",
    "Heartbreaker by MSTRKRFT",
    "Bitch Better Have My Money by Rihanna",
    "My Love by Route 94, Jess Glynne",
    ...
    "Dirrty by Christina Aguilera, Redman",
    "Beautiful Soul by Jesse McCartney",
    "Move on Up - Single Edit by Curtis Mayfield",
    "Follow Me by Uncle Kracker",
    "Khe Sanh - 2011 Remastered by Cold Chisel",
    ...
    "Hakuna Matata by Billy Eichner, Seth Rogen, JD McCrary, Childish Gambino",
    "Torn by Natalie Imbruglia",
    "Stick to the Status Quo by High School Musical Cast, Disney",
    "Buy U a Drank (Shawty Snappin') (feat. Yung Joc) by T-Pain, Yung Joc",
    "Counting The Beat by The Swingers",
    "Easy Lover by Philip Bailey, Phil Collins",
    "Mystery Man by Hot Potato Band",
    ...
    "Point of View - Radio Edit by DB Boulevard",
    "That Don't Impress Me Much by Shania Twain",
    "The Impression That I Get by The Mighty Mighty Bosstones",
    "Shake Your Groove Thing by Peaches & Herb",
    "Hey Baby by DJ ÌÐtzi, The Bellamy Brothers",
    ...
    "Celebration - Single Version by Kool & The Gang",
    "Jessie's Girl by Jessies Girl",
    "That Don't Impress Me Much - Dance Mix by Shania Twain",
    "Come on over Baby (All I Want Is You) - Radio Version by Christina Aguilera",
    "SOS by Rihanna",
    "Kiss Me Thru The Phone by Soulja Boy, Sammie",
    ...
    "TiK ToK by Kesha",
    "Umbrella by Rihanna, JAY-Z",
    "Thrift Shop (feat. Wanz) by Macklemore & Ryan Lewis, Wanz",
    ...
    "My Humps by Black Eyed Peas",
    "Kiss Kiss (feat. T-Pain) by Chris Brown, T-Pain",
    "Temperature by Sean Paul",
    "I Want You Back by The Jackson 5",
    "Since U Been Gone by Kelly Clarkson",
    "7 Things - Single Version by Miley Cyrus",
    ...
    "Come Said The Boy - Digitally Remastered by Mondo Rock",
...
create_player_list = []
accepted_pretty_names = {"gk", "george", "G", "George", "g", "georgina", "Georgina", "georgie", "Georgie"}
...
action_options = [
    "last person to hit the deck drinks",
    "last person with their hands up drinks",
    "girls drink",
    "boys drink",
    "they drink (we all about equality in this game)",
    "least drunk drink",
    "last person to touch a dog drinks",
    "last person to touch a wall drinks",
...
if st.button("LETS GO GIRLS"):
    ...
    if decision == "drink":
        ...
        st.subheader(
            "sing a song with this word in it, first to get it gives out a drink"
        )
        sleep(2)
